...
class FavoriteAdapter(private var moviesList: ArrayList<Movies>) :
    RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder>() {
    inner class FavoriteViewHolder(private var horizontalRvItemBinding: HorizontalRvItemBinding) :
